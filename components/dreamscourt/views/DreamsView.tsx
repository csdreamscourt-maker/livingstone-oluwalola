      ...
      <GlassCard>
        <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="flex shrink-0 items-center justify-center gap-1.5 self-start rounded-full bg-midnight-950 px-3.5 py-2 text-xs font-semibold text-white transition-colors duration-200 hover:bg-midnight-950/85 sm:self-auto"
          >
