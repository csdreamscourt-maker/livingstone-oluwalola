  ...
  return (
    <AdminLayout title="Site settings">
      <div className="max-w-xl space-y-4">
        ...
        {!loading && settings.length === 0 && <p className="text-sm text-gray-500">No settings yet.</p>}
        {settings.map((setting) => (
          <div key={setting.key} className="rounded-xl border border-midnight-950/10 bg-white p-5">
            <label className="mb-2 block text-xs font-semibold uppercase tracking-[0.1em] text-gray-500">{setting.key}</label>
