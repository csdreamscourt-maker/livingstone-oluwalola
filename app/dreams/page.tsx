      ...
      <Container>
        <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-white">A private archive of memory and meaning</h1>
            <p className="mt-3 text-lg text-white/75 max-w-2xl">
              Organize your dreams by feeling, theme, and spiritual significance.
            </p>
          </div>
          <div className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white px-3 py-2 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-4">
            {filteredDreams.map((dream) => (
              <Card key={dream.id} variant="bordered" className="group border-white/10 bg-[#f7f7fb] hover:border-gold-600">
